...
public class RobotMap {
	...
	//constants for initialization of variables on the robot
	public static int stepInitial = 0;
	public static int shooterModeInitial =0;
	public static int lightStepInitial =0;
	public static int autoStepInitial = 0;
	public static double AVGInitial = 0;
	public static double shootPowInitial =0;
	public static double startTimeInitial = 0;
	public static double straightMod = 1;
	public static double turnMod = .6;
	public static double driveMod = 1;
	public static double positionInitial = 0.0;
	public static double incrementInitial = 0.001;
	public static boolean spinUpInitial = false;
	public static boolean lightOnInitial = false;
	
	//ports for for stuff on the robot
	...
	public static int solenoidLeft = 4; //Pneumatics Ctrl Module PCM
	public static int solenoidRight = 5; //Pneumatics Ctrl Module PCM

	public static int canTalonPort = 1; // canPort
	
	public static int relayPort = 0; //relay
	
	public static int ultraLeftPing = 2; // DIO
	public static int ultraLeftEcho = 3; // DIO
	public static int ultraRightPing = 0; // DIO
	public static int ultraRightEcho = 1; // DIO
	...
	public static int encoderShooterDIOA = 10; //DIO
	...
	public static double distanceFromPeg = 13; // in inches for the distance
												// from the gear peg
public static int ultrasonicArraySize = 10;
	...
	public static int pixyShooterDistanceOff = 10;// in pixels for the shooter
													// Pixycam
	public static int pixyShooterDataBuffer = 2; // in pixels for the shooter
													// Pixycam
